...
UART_BUS(UART2, SERIAL_CONSOLE, HW_UART_BAUDRATE_115200, HW_UART_DATABITS_8, HW_UART_PARITY_NONE,
                                HW_UART_STOPBITS_1, 0, 1, HW_DMA_CHANNEL_INVALID, HW_DMA_CHANNEL_INVALID, 0, 0)

/* dg_configUART_ADAPTER && dg_configUSE_CONSOLE */

#elif dg_configUART_ADAPTER
...
#include "config.h"
SPI_SLAVE_DEVICE(SPI2, EX_FLASH, CFG_GPIO_FAKE_FLASH_CS_PORT, CFG_GPIO_FAKE_FLASH_CS_PIN,
       HW_SPI_WORD_8BIT,HW_SPI_POL_LOW, HW_SPI_PHA_MODE_0, HW_SPI_FREQ_DIV_8, -1);

SPI_SLAVE_DEVICE(SPI2, EX_DISPLAY, CFG_GPIO_FAKE_FLASH_CS_PORT, CFG_GPIO_FAKE_FLASH_CS_PIN,
       HW_SPI_WORD_8BIT,HW_SPI_POL_LOW, HW_SPI_PHA_MODE_0, HW_SPI_FREQ_DIV_8, 0);
