...
static void system_init( void *pvParameters )
{
        ...
        Screen_drawString("Dose: 52 #",10,20);
        ...
        OS_TASK_CREATE("BLE Peripheral",                /* The text name assigned to the task, for
                       ...
                       900 * OS_STACK_WORD_SIZE,        /* The number of bytes to allocate to the
                                                           stack of the task. */
...
static void periphSetup(){
        ...
        periph_setup();
        spi_flash = hspi_x = ad_spi_open(EX_FLASH);
        spi_display =  ad_spi_open(EX_DISPLAY);
