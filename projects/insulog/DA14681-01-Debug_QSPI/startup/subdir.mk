...
C_SRCS += \
C:/Insulog/sdk/bsp/startup/config.c \
C:/Insulog/sdk/bsp/startup/system_ARMCM0.c 

S_UPPER_SRCS += \
C:/Insulog/sdk/bsp/startup/startup_ARMCM0.S \
C:/Insulog/sdk/bsp/startup/vector_table.S 
...
startup/vector_table.o: C:/Insulog/sdk/bsp/startup/vector_table.S
	@echo 'Building file: $<'
	@echo 'Invoking: Cross ARM GNU Assembler'
	arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -Wall  -g3 -x assembler-with-cpp -Ddg_configBLACK_ORCA_IC_REV=BLACK_ORCA_IC_REV_A -Ddg_configBLACK_ORCA_IC_STEP=BLACK_ORCA_IC_STEP_E -I"../../sdk/interfaces/ble_stack/" -I"C:\Insulog\sdk\bsp\config" -include"C:\Insulog\projects\insulog\config\custom_config_qspi.h" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
	@echo 'Finished building: $<'
