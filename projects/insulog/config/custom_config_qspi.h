...
#define dg_configEXT_CRYSTAL_FREQ               EXT_CRYSTAL_IS_32M//EXT_CRYSTAL_IS_16M
...
#define dg_configUSE_SEMIHOST 1
#endif
...
#define CONFIG_SPI_USE_DMA_RESMGMT              0
